...
Again, with the requirement of a file called `_quarto.yml` including the lines:
...
This code was run when the file was open but it's possible to Render any Quarto file:
